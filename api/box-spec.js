...
function generateCard(box) {
  const { W: w, H: h } = box;
  const panels = [{ id: "card", parentId: null, outline: rect(0, 0, w, h), stage: 0 }];
  const cut = (d) => ({ kind: "cut", d });
  const segments = [cut(`M 0 0 L ${w} 0 L ${w} ${h} L 0 ${h} Z`)];
  const dims = [
...
var TEMPLATES = [
  ...
  },
  {
    ...
    detail: "\u0E01\u0E32\u0E23\u0E4C\u0E14\u0E41\u0E1A\u0E19\u0E1E\u0E34\u0E21\u0E1E\u0E4C \u0E02\u0E19\u0E32\u0E14\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19 90\xD754 \u0E21\u0E21. \u2014 \u0E2D\u0E2D\u0E01\u0E41\u0E1A\u0E1A\u0E14\u0E49\u0E32\u0E19\u0E2B\u0E19\u0E49\u0E32\u0E41\u0E25\u0E49\u0E27\u0E2A\u0E48\u0E07\u0E1E\u0E34\u0E21\u0E1E\u0E4C \u0E44\u0E21\u0E48\u0E21\u0E35\u0E23\u0E2D\u0E22\u0E1E\u0E31\u0E1A",
...
- card (\u0E19\u0E32\u0E21\u0E1A\u0E31\u0E15\u0E23): \u0E01\u0E32\u0E23\u0E4C\u0E14\u0E41\u0E1A\u0E19\u0E1E\u0E34\u0E21\u0E1E\u0E4C \u0E44\u0E21\u0E48\u0E21\u0E35\u0E23\u0E2D\u0E22\u0E1E\u0E31\u0E1A \u2014 W = \u0E01\u0E27\u0E49\u0E32\u0E07, H = \u0E2A\u0E39\u0E07, \u0E04\u0E48\u0E32 D \u0E44\u0E21\u0E48\u0E43\u0E0A\u0E49 (\u0E43\u0E2A\u0E48\u0E04\u0E48\u0E32\u0E43\u0E14\u0E01\u0E47\u0E44\u0E14\u0E49\u0E43\u0E19\u0E25\u0E34\u0E21\u0E34\u0E15), handle \u0E15\u0E49\u0E2D\u0E07\u0E40\u0E1B\u0E47\u0E19 false; \u0E02\u0E19\u0E32\u0E14\u0E21\u0E32\u0E15\u0E23\u0E10\u0E32\u0E19 90\xD754 \u0E21\u0E21. \u0E40\u0E25\u0E37\u0E2D\u0E01\u0E40\u0E21\u0E37\u0E48\u0E2D\u0E25\u0E39\u0E01\u0E04\u0E49\u0E32\u0E02\u0E2D "\u0E19\u0E32\u0E21\u0E1A\u0E31\u0E15\u0E23 / business card" \u0E40\u0E17\u0E48\u0E32\u0E19\u0E31\u0E49\u0E19 (\u0E40\u0E1B\u0E47\u0E19\u0E07\u0E32\u0E19\u0E1E\u0E34\u0E21\u0E1E\u0E4C\u0E01\u0E32\u0E23\u0E4C\u0E14 \u0E44\u0E21\u0E48\u0E43\u0E0A\u0E48\u0E1A\u0E23\u0E23\u0E08\u0E38\u0E20\u0E31\u0E13\u0E11\u0E4C)
