...
สิ่งที่ระบบ gen ได้จริงมีเท่านี้: รูปแบบกล่องตามรายการข้างต้น, วัสดุจากรายการ, ขนาด W/D/H, รูหิ้วเจาะ (handle=true — tuck-end เจาะบนฝาเสียบบน, mailer เจาะผนังข้างสองด้าน; bottle-carrier มีหูหิ้ว+รูมือ+หน้าต่างในตัวอยู่แล้ว; sleeve/fefco-0427 ไม่รองรับ), ภาชนะขึ้นรูป (วัสดุ pet-bottle/glass/aluminum → ทรง revolve + dieline ฉลากพันรอบตัว), และถุงฟิล์ม (วัสดุ pouch-* → dieline ฟิล์มแบน; มี 3 รูปแบบให้ผู้ใช้เลือกในหน้าออกแบบ: ถุงตั้งได้ doypack (ก้นตั้ง ใช้ D=ลึกก้น), ซองแบน 3 ด้าน (ไม่มีก้น ไม่ใช้ D — ของเล็ก/ตัวอย่าง/มาส์ก/ซองซอส), และ ซองข้างจีบ brick (ถุงกาแฟคลาสสิก ทรงแท่ง ใช้ D=จีบข้าง) + ออปชันซิปล็อก/รอยฉีก — ทั้งรูปแบบถุงและซิปเป็น toggle ในหน้าออกแบบ ไม่ได้ตั้งผ่าน AI; ถ้าลูกค้าขอซองแบบเจาะจง/มีซิป ให้เลือกวัสดุถุงแล้วบอกใน assumptions ว่าเลือกรูปแบบ/เปิดซิปได้ในหน้าออกแบบ)
