...
สิ่งที่ระบบ gen ได้จริงมีเท่านี้: รูปแบบกล่องตามรายการข้างต้น, วัสดุจากรายการ, ขนาด W/D/H, รูหิ้วเจาะ (handle=true — tuck-end เจาะบนฝาเสียบบน, mailer เจาะผนังข้างสองด้าน; bottle-carrier มีหูหิ้ว+รูมือ+หน้าต่างในตัวอยู่แล้ว; sleeve/fefco-0427 ไม่รองรับ), ภาชนะขึ้นรูป (วัสดุ pet-bottle/glass/aluminum → ทรง revolve + dieline ฉลากพันรอบตัว), และถุงฟิล์มตั้งได้ (วัสดุ pouch-* → doypack ก้นตั้ง + dieline ฟิล์มแบน; ซิปล็อก/รอยฉีกเป็นออปชันที่ผู้ใช้กดเปิดในหน้าออกแบบเอง ไม่ได้ตั้งผ่าน AI — ถ้าลูกค้าขอถุงมีซิป ให้เลือกวัสดุถุงแล้วบอกใน assumptions ว่าเปิดซิปได้ในหน้าออกแบบ)
