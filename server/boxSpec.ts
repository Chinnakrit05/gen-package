...
- card (นามบัตร): การ์ดแบนพิมพ์ ไม่มีรอยพับ — W = กว้าง, H = สูง, ค่า D ไม่ใช้ (ใส่ค่าใดก็ได้ในลิมิต), handle ต้องเป็น false; ขนาดมาตรฐาน 90×54 มม. เลือกเมื่อลูกค้าขอ "นามบัตร / business card" เท่านั้น (เป็นงานพิมพ์การ์ด ไม่ใช่บรรจุภัณฑ์)
